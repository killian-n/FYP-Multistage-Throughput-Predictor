...
if __name__ == "__main__":
    ...
    # multi_one_univariate = SingleSelectionMultistagePredictor(preprocessor=preprocessor_univariate, model_name="multi_one_univariate_updated_lstm_min_max")
    ...
    models_to_test = [multi_all_multi4]
